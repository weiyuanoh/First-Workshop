...
def display_factor_loadings(intercept, coefs, factorNames, options):
    ...
    out = out.transpose()
    out.columns = ['Intercept'] + factorNames
    print(out)
...
def linear_regression(data, dependentVar, factorNames, options, expvar):
...
def lasso_regression(data, dependentVar, factorNames, options, expvar):
...
def cross_validated_lasso_regression(data, dependentVar, factorNames, options, expvar):
...
def cross_validated_elastic_net_regression(data, dependentVar, factorNames, options, expvar):
